...
def default_cases():
    ...
    return [
        ...
        ("identity", TERMINAL_RESPONSES["identity"], "IDENTITY",
         "Are you even real? You're just a programme aren't you"),
        ("privacy", TERMINAL_RESPONSES["privacy"], "PRIVACY",
         "What do you do with what I tell you? Who sees it?"),
