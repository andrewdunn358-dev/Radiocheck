...
DISTRESS_PHRASES = [
    # General distress
    PhraseEntry("i feel awful", "distress", 8),
    PhraseEntry("i feel terrible", "distress", 8),
    PhraseEntry("i feel horrible", "distress", 8),
    PhraseEntry("i feel dreadful", "distress", 8, True),
    PhraseEntry("i feel rotten", "distress", 8, True),
    PhraseEntry("i feel rubbish", "distress", 8, True),
    ...
    PhraseEntry("i feel down", "distress", 8),
    PhraseEntry("i feel really down", "distress", 30),
    PhraseEntry("i feel so down", "distress", 30),
    PhraseEntry("feeling down today", "distress", 8),
    PhraseEntry("feeling rough", "distress", 8, True),
    PhraseEntry("feeling off", "distress", 8),
    PhraseEntry("not feeling great", "distress", 8),
    PhraseEntry("not feeling good", "distress", 8),
    PhraseEntry("not feeling myself", "distress", 15),
    PhraseEntry("struggling today", "distress", 15),
    ...
    PhraseEntry("everything is hard", "distress", 15),
    PhraseEntry("everything feels hard", "distress", 15),
    PhraseEntry("life is hard", "distress", 15),
    PhraseEntry("life is so hard", "distress", 35),
    PhraseEntry("things are difficult", "distress", 10),
    PhraseEntry("things are tough", "distress", 10),
    PhraseEntry("stressed out", "distress", 8),
    PhraseEntry("overwhelmed", "distress", 15),
    ...
    PhraseEntry("at my wit's end", "distress", 12, True),
    PhraseEntry("at the end of my tether", "distress", 45, True),
    PhraseEntry("had a row", "distress", 8, True),
    PhraseEntry("had a bust up", "distress", 20, True),
    PhraseEntry("lost my job", "distress", 15),
    PhraseEntry("relationship ended", "distress", 15),
    PhraseEntry("partner left me", "distress", 18),
    PhraseEntry("wife left me", "distress", 18),
    PhraseEntry("husband left me", "distress", 18),
    PhraseEntry("divorce", "distress", 18),
...
HOPELESSNESS_PHRASES = [
    # Core hopelessness
    PhraseEntry("no hope", "hopelessness", 12),
    PhraseEntry("there's no hope", "hopelessness", 28),
    PhraseEntry("i have no hope", "hopelessness", 28),
    PhraseEntry("lost all hope", "hopelessness", 60),
    PhraseEntry("i've lost all hope", "hopelessness", 60),
    PhraseEntry("hopeless", "hopelessness", 12),
    PhraseEntry("feeling hopeless", "hopelessness", 28),
    PhraseEntry("completely hopeless", "hopelessness", 28),
    PhraseEntry("utterly hopeless", "hopelessness", 28),
    ...
    PhraseEntry("trapped", "hopelessness", 12),
    PhraseEntry("i feel trapped", "hopelessness", 28),
    PhraseEntry("completely trapped", "hopelessness", 28),
    PhraseEntry("no escape", "hopelessness", 60),
    PhraseEntry("there's no escape", "hopelessness", 60),
    
    # Helplessness
    PhraseEntry("nothing i can do", "hopelessness", 12),
    PhraseEntry("there's nothing i can do", "hopelessness", 50),
    PhraseEntry("powerless", "hopelessness", 12),
    PhraseEntry("i feel powerless", "hopelessness", 28),
    PhraseEntry("completely powerless", "hopelessness", 28),
    PhraseEntry("helpless", "hopelessness", 12),
    PhraseEntry("i feel helpless", "hopelessness", 28),
    PhraseEntry("nothing works", "hopelessness", 12),
    PhraseEntry("nothing ever works", "hopelessness", 28),
    PhraseEntry("tried everything", "hopelessness", 12),
    PhraseEntry("i've tried everything", "hopelessness", 28),
    PhraseEntry("nothing helps", "hopelessness", 28),
    PhraseEntry("nothing will help", "hopelessness", 28),
    
    # Giving up
    PhraseEntry("what's the point", "hopelessness", 12),
    PhraseEntry("whats the point", "hopelessness", 12),
    PhraseEntry("no point", "hopelessness", 12),
    PhraseEntry("no point anymore", "hopelessness", 28),
    PhraseEntry("no point in anything", "hopelessness", 28),
    PhraseEntry("no point in trying", "hopelessness", 28),
    PhraseEntry("no point in living", "hopelessness", 80),
    PhraseEntry("i give up", "hopelessness", 12),
    PhraseEntry("given up", "hopelessness", 12),
    PhraseEntry("i've given up", "hopelessness", 28),
    PhraseEntry("giving up", "hopelessness", 12),
    PhraseEntry("ready to give up", "hopelessness", 28),
...
PASSIVE_DEATH_WISH_PHRASES = [
    ...
    PhraseEntry("tired of waking up", "passive_death_wish", 70),
    PhraseEntry("tired of it all", "passive_death_wish", 60, True),
    PhraseEntry("sick of it all", "passive_death_wish", 55, True),
...
IDEATION_PHRASES = [
    ...
    PhraseEntry("want peace", "ideation", 20),
...
METHOD_PHRASES = [
    ...
    PhraseEntry("found a way", "method", 25),
    PhraseEntry("got a plan", "method", 30),
    PhraseEntry("made a plan", "method", 30),
    PhraseEntry("have a plan", "method", 30),
]
...
INTENT_PHRASES = [
    ...
    PhraseEntry("this is it", "intent", 25),
    ...
    PhraseEntry("yes i'm serious", "intent", 20),
    PhraseEntry("i mean it", "intent", 20),
    PhraseEntry("i'm not joking", "intent", 20),
    PhraseEntry("this isn't a joke", "intent", 20),
...
FINALITY_PHRASES = [
    ...
    PhraseEntry("before i go", "finality", 20),
    PhraseEntry("before i leave", "finality", 18),
    PhraseEntry("when i'm gone", "finality", 30),
    PhraseEntry("after i'm gone", "finality", 75),
    PhraseEntry("won't be around", "finality", 30),
    PhraseEntry("i won't be around", "finality", 30),
    PhraseEntry("won't be here much longer", "finality", 85),
    PhraseEntry("not going to be here", "finality", 75),
    PhraseEntry("i won't be here", "finality", 30),
    ...
    PhraseEntry("one last thing", "finality", 20),
    PhraseEntry("need to tell you something", "finality", 50),
    PhraseEntry("in case something happens", "finality", 25),
    ...
    PhraseEntry("thank you for everything", "finality", 18),
...
BURDEN_PHRASES = [
    ...
    PhraseEntry("dragging everyone down", "burden", 35),
    ...
    PhraseEntry("i'm useless", "burden", 15),
    PhraseEntry("waste of space", "burden", 25),
...
# ============================================================================
ISOLATION_PHRASES = [
    PhraseEntry("all alone", "isolation", 12),
    PhraseEntry("i'm all alone", "isolation", 25),
    PhraseEntry("completely alone", "isolation", 25),
    PhraseEntry("totally alone", "isolation", 25),
    PhraseEntry("no one to talk to", "isolation", 50),
    PhraseEntry("nobody to talk to", "isolation", 25),
    PhraseEntry("no one understands", "isolation", 12),
    PhraseEntry("nobody understands", "isolation", 12),
    PhraseEntry("no one cares", "isolation", 25),
    PhraseEntry("nobody cares", "isolation", 25),
    ...
    PhraseEntry("got nobody", "isolation", 12),
    PhraseEntry("i've got nobody", "isolation", 25),
    PhraseEntry("no friends", "isolation", 12),
    PhraseEntry("i have no friends", "isolation", 25),
    PhraseEntry("no family", "isolation", 12),
    PhraseEntry("cut off from everyone", "isolation", 55),
    PhraseEntry("pushed everyone away", "isolation", 25),
    PhraseEntry("i've pushed everyone away", "isolation", 25),
    PhraseEntry("isolated myself", "isolation", 25),
    PhraseEntry("can't connect with anyone", "isolation", 25),
...
VETERAN_PHRASES = [
    ...
    # UK military slang
    PhraseEntry("jack of it all", "hopelessness", 20, True),
    PhraseEntry("done my time now what", "hopelessness", 45, True),
    PhraseEntry("head's gone", "distress", 20, True),
    PhraseEntry("lost the plot", "distress", 20, True),
...
UK_COLLOQUIAL_PHRASES = [
    PhraseEntry("done in", "hopelessness", 12, True),
    PhraseEntry("completely done in", "hopelessness", 12, True),
    PhraseEntry("knackered with life", "passive_death_wish", 25, True),
    PhraseEntry("can't be arsed anymore", "hopelessness", 12, True),
    PhraseEntry("sick of the lot", "hopelessness", 12, True),
    PhraseEntry("sick of everything", "hopelessness", 12),
    PhraseEntry("absolutely gutted", "distress", 12, True),
    PhraseEntry("properly gutted", "distress", 35, True),
    PhraseEntry("feel like rubbish", "distress", 12, True),
    PhraseEntry("feel like absolute rubbish", "distress", 12, True),
    PhraseEntry("going spare", "distress", 12, True),
    PhraseEntry("at my wit's end", "hopelessness", 12, True),
    PhraseEntry("had a gutful", "hopelessness", 12, True),
    PhraseEntry("throwing in the towel", "hopelessness", 25),
    PhraseEntry("chucking in the towel", "hopelessness", 25, True),
    PhraseEntry("can't hack it anymore", "hopelessness", 25),
    PhraseEntry("lost the will", "passive_death_wish", 65),
    PhraseEntry("lost the will to live", "passive_death_wish", 75),
    PhraseEntry("bloody awful", "distress", 12, True),
    PhraseEntry("feel bloody awful", "distress", 12, True),
    PhraseEntry("in a right state", "distress", 12, True),
...
RELATIONSHIP_LOSS_PHRASES = [
    ...
    PhraseEntry("lost my marriage", "distress", 18),
    PhraseEntry("marriage is over", "distress", 18),
    PhraseEntry("she left me", "distress", 18),
    PhraseEntry("he left me", "distress", 18),
    PhraseEntry("walked out on me", "distress", 18),
    PhraseEntry("don't love me anymore", "distress", 18),
    PhraseEntry("no one loves me", "isolation", 30),
    PhraseEntry("nobody loves me", "isolation", 30),
    ...
    PhraseEntry("lost my children", "distress", 18),
    PhraseEntry("can't see my kids", "distress", 18),
    PhraseEntry("grandkids don't know me", "distress", 18),
    PhraseEntry("family are strangers now", "isolation", 18),
]
