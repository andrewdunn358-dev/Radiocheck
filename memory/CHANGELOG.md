...
- Admin action logging (settings, staff CRUD, callbacks)

### Staff Profile Editing (P1)
- Enhanced edit modal with full profile fields
- Basic info, contact info, role-specific fields

### Callback "Take" Button Fix
- Backend status mismatch fixed (`in_progress` → `taken`)

### Interaction Notes System
- Full CRUD for notes
- Linking to callbacks, alerts, cases
...
- Auto-re-registration on reconnect
