        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-secondary">Welcome to Radio Check</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-secondary">What Radio Check Is</h2>
              <p className="text-white/80 mb-4">Radio Check is:</p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-secondary">What Radio Check Is NOT</h2>
              <p className="text-white/80 mb-4 font-semibold text-amber-400">Important: Please understand these limitations:</p>
              <ul className="list-disc list-inside text-white/80 mb-4 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-secondary">AI Companions</h2>
              <p className="text-white/80 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-secondary">User Responsibilities</h2>
              <p className="text-white/80 mb-4">By using Radio Check, you agree to:</p>
              <ul className="list-disc list-inside text-white/80 mb-4 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-secondary">Crisis Resources</h2>
              <p className="text-white/80 mb-4">If you&apos;re in crisis, please contact:</p>
              <ul className="list-disc list-inside text-white/80 mb-4 space-y-2">
