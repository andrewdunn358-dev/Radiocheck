...
const PERSONA_DATA: Record<string, { name: string; desc: string; color: string; avatar: string }> = {
  ...
  jack: { name: 'Jack', desc: 'Housing & benefits specialist.', color: '#1e40af', avatar: '/images/jack.png' },
  kofi: { name: 'Kofi', desc: 'Commonwealth veteran support.', color: '#14b8a6', avatar: '/images/kofi.png' },
  catherine: { name: 'Catherine', desc: 'Faith & spirituality support.', color: '#0891b2', avatar: '/images/catherine.png' },
  sam: { name: 'Sam', desc: 'Substance misuse support.', color: '#f97316', avatar: '/images/sam.png' },
  rita: { name: 'Rita', desc: 'Female veteran support.', color: '#7c3aed', avatar: '/images/rita.png' },
  james: { name: 'James', desc: 'Historical investigations support.', color: '#8b5cf6', avatar: '/images/james.png' },
  baz: { name: 'Baz', desc: 'Veteran peer support.', color: '#059669', avatar: '/images/baz.png' },
  ...
  alex: { name: 'Alex', desc: 'LGBTQ+ veteran support.', color: '#ec4899', avatar: '/images/alex.png' },
